...
const TICKETS = {
  bought:[
    ...
    {
      day:7, date:"10/11（日）", city:"哈修塔特",
      name:"哈修塔特鹽礦＋纜車套票 Salzwelten Hallstatt",
      big:"10:30", bigk:"導覽開始 Tour-Beginn",
      kv:[
      ...
      warn:"票面入場日期為 **2026/10/11（日）10:30**，與行程總表把鹽礦排在 Day 8（10/12）09:30 不一致，出發前務必先確認要調整哪一邊。綁定場次、不可改期退費。",
      rules:[
        ["報到時間","官方要求**導覽前 45 分鐘**抵達纜車山下站，即 **09:45 前**；含纜車上山與約 15 分鐘步行至 Knappenhaus 集合點。"],
  ...
  notes:[
    ...
    ["三張都不可改期","新天鵝堡、國王湖與哈修塔特鹽礦都綁定日期與時間。行程若因天候調整，這三個時間點是固定錨點，其餘往前後挪。"],
    ["鹽礦票日期待確認","票面為 10/11（Day 7）10:30，行程總表排在 10/12（Day 8）09:30。兩者擇一調整前，Day 7、Day 8 的安排都不算定案。"],
  ],
};
...
const ACCESS = [
  ...
  },
  {
    ...
    up:[
      ["1","步行到山下站","住宿區步行 30 分鐘到 Salzbergbahn 山下站，08:40 到，出示套票排首班。"],
      ["2","纜車","新纜車無障礙，乘車約 2 分鐘上到哈修塔特高谷。"],
      ["3","走到 Knappenhaus","山頂站 → 礦工之家 Knappenhaus 約 15 分鐘步行，導覽在此集合開始。09:25 前到。"],
      ["4","導覽","礦內恆溫 8 °C，穿保暖衣物與防滑鞋；現場一律加穿提供的連身防護衣。礦內步行約 2 km，有 64 m 礦工滑梯（可不滑走樓梯），最後搭礦車出洞。"],
    ],
    down:[
      ["天空步道","出洞後步行約 20 分鐘到 Skywalk 觀景台，再回山頂站。"],
      ["纜車","搭纜車回山下站，**12:00 離開山下站**開往普里恩與慕尼黑。"],
    ],
    notes:[
